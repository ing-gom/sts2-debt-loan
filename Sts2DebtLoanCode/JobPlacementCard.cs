...
/// <see cref="DrawWages"/> shuffled into your DRAW pile. Base feeds 품삯 (0-cost, 15 gold); upgraded (취업알선+) feeds
/// 품삯+ (0-cost, 25 gold) → 3×15 = 45 base / 3×25 = 75 upgraded. EXHAUST caps it at one payout per combat so it
