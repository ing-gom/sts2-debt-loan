...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, Row> ByLang = new()
    {
        ...
        ["jpn"] = new("借金台帳",
            ...
            "強制徴収", "ターン終了時、体力を[b]{hp}[/b]失い、借金[gold]{principal} ゴールド[/gold]を返済してから廃棄。"),
        ...
        ["zhs"] = new("债务账簿",
            ...
            "每一个签名都是一次小小的屈服。",
            "还款", "偿还 [gold]20 金币[/gold]的债务。获得[gold]收据[/gold]1张，若成功偿还则再获得1张。",
            ...
            "强制征收", "回合结束时，失去 [b]{hp}[/b] 点生命并偿还 [gold]{principal} 金币[/gold] 债务，然后消耗。"),
        ...
        ["deu"] = new("Schuldenbuch",
            ...
            "Zahlung", "Tilge [b]20[/b] [gold]Gold[/gold] deiner Schuld. Erhalte 1 [gold]Beleg[/gold] und 1 weiteren, wenn du getilgt hast.",
        ...
        ["fra"] = new("Grand livre des dettes",
            ...
            "Paiement", "Rembourse [b]20[/b] [gold]or[/gold] de ta dette. Gagne 1 [gold]Reçu[/gold], et 1 de plus si tu as remboursé.",
        ...
        ["spa"] = new("Libro de deudas",
            ...
            "Pago", "Salda [b]20[/b] [gold]de oro[/gold] de tu deuda. Gana 1 [gold]Recibo[/gold] y 1 más si saldaste.",
        ...
        ["ita"] = new("Registro dei debiti",
            ...
            "Pagamento", "Ripaga [b]20[/b] [gold]Oro[/gold] del tuo debito. Ottieni 1 [gold]Ricevuta[/gold] e 1 in più se hai ripagato.",
        ...
        ["pol"] = new("Księga długów",
            ...
            "Spłata", "Spłać [b]20[/b] [gold]złota[/gold] długu. Zyskaj 1 [gold]Paragon[/gold] i 1 więcej, jeśli spłaciłeś.",
        ...
        ["ptb"] = new("Livro-razão de dívidas",
            ...
            "Pagamento", "Quite [b]20[/b] [gold]de Ouro[/gold] da sua dívida. Ganhe 1 [gold]Recibo[/gold] e mais 1 se quitou.",
        ...
        ["rus"] = new("Долговая книга",
            ...
            "Платёж", "Погасите [b]20[/b] [gold]золота[/gold] долга. Получите 1 [gold]Чек[/gold] и ещё 1, если погасили.",
        ...
        ["tha"] = new("บัญชีหนี้",
            ...
            "การชำระ", "ชำระหนี้ [gold]20 ทอง[/gold] รับ[gold]ใบเสร็จ[/gold] 1 และอีก 1 ถ้าชำระได้",
            ...
            "บังคับเก็บหนี้", "เมื่อจบเทิร์น เสียพลังชีวิต [b]{hp}[/b] และชำระหนี้ [gold]{principal} ทอง[/gold] จากนั้นเผาไหม้"),
        ...
        ["tur"] = new("Borç Defteri",
            ...
            "Ödeme", "Borcundan [b]20[/b] [gold]Altın[/gold] öde. 1 [gold]Makbuz[/gold] kazan, ödeyebildiysen 1 daha.",
            ...
            "Zorla Tahsilat", "Turunun sonunda [b]{hp}[/b] Can kaybeder ve [gold]{principal} Altın[/gold] borç ödersin, sonra Tükenir."),
    };
    ...
    {
        ["eng"] = new("Payment", "Paying down your debt during combat. Your debt drops by the full amount paid."),
        ["kor"] = new("납부", "전투 중에 빚을 갚는 행위입니다. 낸 만큼 빚이 줄어듭니다."),
        ["jpn"] = new("支払い", "戦闘中に借金を返す行為。払った分だけ借金が減る。"),
        ["zhs"] = new("还款", "在战斗中偿还债务。债务按支付的全额减少。"),
        ["deu"] = new("Zahlung", "Deine Schuld im Kampf abbezahlen. Die Schuld sinkt um den vollen gezahlten Betrag."),
        ["fra"] = new("Paiement", "Rembourser ta dette pendant le combat. La dette baisse du montant total payé."),
        ["spa"] = new("Pago", "Saldar tu deuda durante el combate. La deuda baja por el importe completo pagado."),
        ["esp"] = new("Pago", "Saldar tu deuda durante el combate. La deuda baja por el importe completo pagado."),
        ["ita"] = new("Pagamento", "Ripagare il debito durante il combattimento. Il debito cala dell'intero importo pagato."),
        ["pol"] = new("Spłata", "Spłacanie długu w trakcie walki. Dług maleje o pełną zapłaconą kwotę."),
        ["ptb"] = new("Pagamento", "Pagar sua dívida durante o combate. A dívida cai pelo valor total pago."),
        ["rus"] = new("Платёж", "Погашение долга в бою. Долг уменьшается на всю уплаченную сумму."),
        ["tha"] = new("การชำระ", "การชำระหนี้ระหว่างการต่อสู้ หนี้จะลดลงเต็มจำนวนที่จ่าย"),
        ["tur"] = new("Ödeme", "Savaş sırasında borcunu ödemek. Borç, ödenen tutarın tamamı kadar azalır."),
    };
    ...
    {
        ["eng"] = new("Receipt", "Making a [gold]Payment[/gold] earns [gold]Receipts[/gold]. This card spends them."),
        ["kor"] = new("영수증", "[gold]납부[/gold]하면 [gold]영수증[/gold]을 얻습니다. 이 카드는 [gold]영수증[/gold]을 소비합니다."),
        ["jpn"] = new("レシート", "[gold]支払い[/gold]を行うと[gold]レシート[/gold]を得る。このカードは[gold]レシート[/gold]を消費する。"),
        ["zhs"] = new("收据", "进行[gold]还款[/gold]可获得[gold]收据[/gold]。此牌会消耗[gold]收据[/gold]。"),
        ["deu"] = new("Beleg", "Eine [gold]Zahlung[/gold] bringt [gold]Belege[/gold]. Diese Karte verbraucht sie."),
        ["fra"] = new("Reçu", "Un [gold]paiement[/gold] te rapporte des [gold]reçus[/gold]. Cette carte en dépense."),
        ["spa"] = new("Recibo", "Un [gold]pago[/gold] te otorga [gold]recibos[/gold]. Esta carta los gasta."),
        ["esp"] = new("Recibo", "Un [gold]pago[/gold] te otorga [gold]recibos[/gold]. Esta carta los gasta."),
        ["ita"] = new("Ricevuta", "Un [gold]pagamento[/gold] ti dà [gold]ricevute[/gold]. Questa carta le consuma."),
        ["pol"] = new("Paragon", "[gold]Spłata[/gold] daje [gold]paragony[/gold]. Ta karta je zużywa."),
        ["ptb"] = new("Recibo", "Um [gold]pagamento[/gold] rende [gold]recibos[/gold]. Esta carta os gasta."),
        ["rus"] = new("Чек", "[gold]Платёж[/gold] приносит [gold]чеки[/gold]. Эта карта их тратит."),
        ["tha"] = new("ใบเสร็จ", "การ[gold]ชำระ[/gold]จะได้รับ[gold]ใบเสร็จ[/gold] การ์ดนี้ใช้[gold]ใบเสร็จ[/gold]"),
        ["tur"] = new("Makbuz", "[gold]Ödeme[/gold] yapmak [gold]makbuz[/gold] kazandırır. Bu kart makbuz harcar."),
    };
    ...
    {
        ["eng"] = "Your current [gold]Receipt[/gold] count. Payments earn Receipts, and some cards spend them.",
        ["kor"] = "현재 보유한 [gold]영수증[/gold] 개수. [gold]납부[/gold]하면 얻으며, 일부 카드가 영수증을 소비합니다.",
        ["jpn"] = "現在の[gold]レシート[/gold]の数。支払いを行うと得られ、一部のカードがレシートを消費する。",
        ["zhs"] = "你当前的[gold]收据[/gold]数量。还款可获得收据，部分卡牌会消耗收据。",
        ["deu"] = "Deine aktuelle Anzahl an [gold]Belegen[/gold]. Zahlungen bringen Belege; manche Karten verbrauchen sie.",
        ["fra"] = "Ton nombre actuel de [gold]reçus[/gold]. Les paiements en rapportent ; certaines cartes en dépensent.",
        ["spa"] = "Tu cantidad actual de [gold]recibos[/gold]. Los pagos otorgan recibos; algunas cartas los gastan.",
        ["esp"] = "Tu cantidad actual de [gold]recibos[/gold]. Los pagos otorgan recibos; algunas cartas los gastan.",
        ["ita"] = "Il tuo numero attuale di [gold]ricevute[/gold]. I pagamenti danno ricevute; alcune carte le consumano.",
        ["pol"] = "Twoja aktualna liczba [gold]paragonów[/gold]. Spłaty dają paragony; niektóre karty je zużywają.",
        ["ptb"] = "Sua quantidade atual de [gold]recibos[/gold]. Pagamentos rendem recibos; algumas cartas os gastam.",
        ["rus"] = "Ваше текущее количество [gold]чеков[/gold]. Платежи приносят чеки; некоторые карты их тратят.",
        ["tha"] = "จำนวน[gold]ใบเสร็จ[/gold]ที่คุณมีตอนนี้ การชำระจะได้รับใบเสร็จ การ์ดบางใบใช้ใบเสร็จ",
        ["tur"] = "Mevcut [gold]makbuz[/gold] sayın. Ödemeler makbuz kazandırır; bazı kartlar makbuz harcar.",
    };
    ...
    {
        ["eng"] = new("Repay Loan", "Pay back {0} gold to clear your debt. The Ledger and your debt cards stay — your debt tier resets to 1 (your Credit score is untouched — it never resets).", "Not enough gold — you owe {0}.", "No loan to repay.", "You cannot repay at the shop you borrowed from. Settle at the next one."),
        ["kor"] = new("빚 갚기", "{0} 골드를 갚아 빚을 청산합니다. 장부와 결제 카드는 남고, 빚 등급이 1로 돌아갑니다(신용도는 그대로 — 절대 리셋되지 않습니다).", "골드가 부족합니다 — {0} 골드를 빚지고 있습니다.", "갚을 빚이 없습니다.", "빌린 상점에서는 갚을 수 없습니다. 다음 상점에서 청산하세요."),
        ["jpn"] = new("借金返済", "{0} ゴールドを返済して借金を清算する。台帳と決済カードは残り、借金の等級が1に戻る（信用度はそのまま——決してリセットされない）。", "ゴールドが足りない — {0} の借りがある。", "返済する借金がない。", "借りた店では返済できない。次の店で清算しよう。"),
        ["zhs"] = new("偿还贷款", "偿还 {0} 金币以结清债务。账簿与结算牌保留，债务等级重置为 1（信用不受影响，永不重置）。", "金币不足——你欠 {0}。", "没有需要偿还的贷款。", "不能在借款的商店偿还。请到下一家商店结清。"),
        ...
        ["tha"] = new("ชำระหนี้", "จ่าย {0} ทอง เพื่อปิดหนี้ สมุดและการ์ดชำระยังอยู่ และระดับหนี้กลับเป็น 1 (เครดิตไม่ถูกแตะต้อง ไม่มีวันรีเซ็ต)", "ทองไม่พอ — คุณติดหนี้ {0}", "ไม่มีหนี้ให้ชำระ", "ชำระที่ร้านที่คุณกู้มาไม่ได้ ไปปิดบัญชีที่ร้านถัดไป"),
    ...
    // ── 목돈 상환의 신용도 인정 한도 안내 ─────────────────────────────────────────────────────
    /// <summary>{0}=한도(신용도 표기). 사다리 툴팁 하단에 붙는 규칙 한 줄.</summary>
    private static readonly Dictionary<string, string> LumpCapNoteByLang = new()
    {
        ["eng"] = "Lump-sum repayment counts toward Credit only up to {0}. Past that, Credit rises through payments alone.",
        ["kor"] = "목돈 상환은 누적 {0}까지만 신용도로 인정됩니다. 그 위로는 납부로만 신용도가 오릅니다.",
        ["jpn"] = "一括返済が信用度になるのは累計 {0} まで。それ以降は支払いだけが信用度を上げる。",
        ["zhs"] = "一次性偿还只计入信用至累计 {0}。此后信用只能通过还款提升。",
        ["deu"] = "Einmalzahlungen zählen nur bis {0} zur Bonität. Darüber hinaus steigt die Bonität allein durch Zahlungen.",
        ["fra"] = "Le remboursement en une fois ne compte pour le Crédit que jusqu'à {0}. Au-delà, seul le paiement fait monter le Crédit.",
        ["spa"] = "El pago único cuenta para el Crédito solo hasta {0}. A partir de ahí, el Crédito sube solo con los pagos.",
        ["esp"] = "El pago único cuenta para el Crédito solo hasta {0}. A partir de ahí, el Crédito sube solo con los pagos.",
        ["ita"] = "Il saldo in un'unica soluzione conta per il Credito solo fino a {0}. Oltre, il Credito sale solo con i pagamenti.",
        ["pol"] = "Spłata jednorazowa liczy się do Zdolności tylko do {0}. Powyżej Zdolność rośnie wyłącznie przez spłaty ratalne.",
        ["ptb"] = "O pagamento à vista conta para o Crédito só até {0}. Acima disso, o Crédito sobe apenas com os pagamentos.",
        ["rus"] = "Разовое погашение идёт в Кредит только до {0}. Выше Кредит растёт лишь за счёт платежей.",
        ["tha"] = "การชำระก้อนเดียวนับเป็นเครดิตได้ถึง {0} เท่านั้น เกินจากนั้นเครดิตขึ้นได้ด้วยการชำระเท่านั้น",
        ["tur"] = "Toplu ödeme Krediye yalnızca {0} değerine kadar sayılır. Ötesinde Kredi yalnızca ödemelerle yükselir.",
    };

    internal static string LumpCapNoteFor(string? lang)
        => lang != null && LumpCapNoteByLang.TryGetValue(lang, out var s) ? s : LumpCapNoteByLang["eng"];
    ...
    private static readonly Dictionary<string, string> _cardsEng = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "At the end of your turn, make a [gold]{gold} Gold[/gold] [gold]Payment[/gold] — or, if you can't afford it, lose [b]{hp}[/b] HP and pay in blood. Gain 1 [gold]Receipt[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Exhaust every [gold]Debt[/gold] card you hold and gain that much [b]Strength[/b]. Gain [gold]Bankruptcy[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Leverage",
                        ["SEIZED_GOODS_CARD.title"] = "Seized Goods",
            ["SEIZED_GOODS_CARD.description"] = "Gain [b]{block}[/b] Block.\nShuffled into your draw pile at the start of combat, by how much debt you owe.",
            ["COLLATERAL_CARD.title"] = "Collateral",
            ["COLLATERAL_CARD.description"] = "Gain [b]1[/b] Block per [gold]{per} Gold[/gold] of debt you owe.\nCurrently [b]{amount}[/b] Block",
            ["DEFAULT_RISK_CARD.title"] = "Default Risk",
            ["DEFAULT_RISK_CARD.description"] = "Gain [b]1[/b] Strength per [gold]{per} Gold[/gold] of debt you owe.\nCurrently [b]{amount}[/b] Strength",
            ["BAD_DEBT_CARD.title"] = "Bad Debt",
            ["BAD_DEBT_CARD.description"] = "Deal [b]{per}[/b] damage for each Curse in your hand.\nCurrently [b]{amount}[/b] damage",
            ["LEVERAGE_CARD.description"] = "Deal [b]1[/b] damage per [gold]{per} Gold[/gold] of debt you owe.\nCurrently [b]{amount}[/b] damage",
            ["RESTRUCTURING_CARD.title"] = "Restructuring",
            ["RESTRUCTURING_CARD.description"] = "Write off [gold]{cut} Gold[/gold] of debt.\nOnce per loan.",
        ...
        ["BAILOUT_CARD.description"] = "Pay [b]20[/b] [gold]Gold[/gold] toward the targeted ally's debt. That ally gains 1 [gold]Receipt[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Lose [b]{hp}[/b] HP and make a [gold]{pay} Gold[/gold] [gold]Payment[/gold]. Gain 1 [gold]Receipt[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsKor = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "턴 종료 시 [gold]{gold} 골드[/gold]를 [gold]납부[/gold]합니다 — 골드가 부족하면 체력 [b]{hp}[/b]을 잃고 대신 납부합니다. [gold]영수증[/gold] 1을 얻습니다.",
        ["WAGES_CARD.title"] = "품삯",
        ...
        ["BANKRUPTCY_CARD.description"] = "보유한 [gold]빚[/gold] 카드를 모두 소멸시키고 그 수만큼 힘을 얻습니다. [gold]파산[/gold]을 얻습니다.",
            ...
            ["LEVERAGE_CARD.title"] = "레버리지",
                        ["SEIZED_GOODS_CARD.title"] = "압류품",
            ["SEIZED_GOODS_CARD.description"] = "방어도 [b]{block}[/b]을 얻습니다.\n남은 빚의 크기에 따라 전투 시작 시 드로우 더미에 섞입니다.",
            ["COLLATERAL_CARD.title"] = "담보",
            ["COLLATERAL_CARD.description"] = "남은 빚 [gold]{per} 골드[/gold]당 방어도 [b]1[/b]을 얻습니다.\n현재 방어도 [b]{amount}[/b]",
            ["DEFAULT_RISK_CARD.title"] = "부도 위기",
            ["DEFAULT_RISK_CARD.description"] = "남은 빚 [gold]{per} 골드[/gold]당 [b]힘[/b] [b]1[/b]을 얻습니다.\n현재 힘 [b]{amount}[/b]",
            ["BAD_DEBT_CARD.title"] = "부실채권",
            ["BAD_DEBT_CARD.description"] = "손에 든 저주 1장당 피해 [b]{per}[/b]을 줍니다.\n현재 피해 [b]{amount}[/b]",
            ["LEVERAGE_CARD.description"] = "남은 빚 [gold]{per} 골드[/gold]당 피해 [b]1[/b]을 줍니다.\n현재 피해 [b]{amount}[/b]",
            ["RESTRUCTURING_CARD.title"] = "채무 조정",
            ["RESTRUCTURING_CARD.description"] = "빚 [gold]{cut} 골드[/gold]를 탕감합니다.\n대출당 [b]1[/b]회만 사용할 수 있습니다.",
        ...
        ["BAILOUT_CARD.description"] = "대상 아군의 빚을 [gold]20 골드[/gold]만큼 대신 갚습니다. 그 아군이 [gold]영수증[/gold] 1을 얻습니다.",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "체력 [b]{hp}[/b]을 잃고 [gold]{pay} 골드[/gold]를 [gold]납부[/gold]합니다. [gold]영수증[/gold] 1을 얻습니다.",
    ...
    private static readonly Dictionary<string, string> _cardsJpn = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "ターン終了時、[gold]{gold} ゴールド[/gold]の[gold]支払い[/gold]を行う — 支払えなければ、体力を [b]{hp}[/b] 失って血で支払う。[gold]レシート[/gold]1を得る。",
        ["WAGES_CARD.title"] = "賃金",
        ...
        ["BANKRUPTCY_CARD.description"] = "手札の[gold]借金[/gold]カードをすべて消耗し、その枚数分の[b]筋力[/b]を得る。[gold]破産[/gold]を得る。",
            ...
            ["LEVERAGE_CARD.title"] = "レバレッジ",
                        ["SEIZED_GOODS_CARD.title"] = "差押品",
            ["SEIZED_GOODS_CARD.description"] = "ブロック[b]{block}[/b]を得る。\n残りの借金の大きさに応じて、戦闘開始時にドローの山に混ざる。",
            ["COLLATERAL_CARD.title"] = "担保",
            ["COLLATERAL_CARD.description"] = "残りの借金[gold]{per}ゴールド[/gold]ごとにブロック[b]1[/b]を得る。\n現在ブロック[b]{amount}[/b]",
            ["DEFAULT_RISK_CARD.title"] = "デフォルト危機",
            ["DEFAULT_RISK_CARD.description"] = "残りの借金[gold]{per}ゴールド[/gold]ごとに[b]筋力[/b][b]1[/b]を得る。\n現在筋力[b]{amount}[/b]",
            ["BAD_DEBT_CARD.title"] = "不良債権",
            ["BAD_DEBT_CARD.description"] = "手札の呪い1枚につき[b]{per}[/b]ダメージを与える。\n現在ダメージ[b]{amount}[/b]",
            ["LEVERAGE_CARD.description"] = "残りの借金[gold]{per}ゴールド[/gold]ごとに[b]1[/b]ダメージを与える。\n現在ダメージ[b]{amount}[/b]",
            ["RESTRUCTURING_CARD.title"] = "債務調整",
            ["RESTRUCTURING_CARD.description"] = "借金[gold]{cut} ゴールド[/gold]を免除する。\n1回の借入につき[b]1[/b]度だけ。",
        ...
        ["BAILOUT_CARD.description"] = "対象の味方の借金を[gold]20 ゴールド[/gold]分だけ代わりに支払う。その味方が[gold]レシート[/gold]1を得る。",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "体力を [b]{hp}[/b] 失い、[gold]{pay} ゴールド[/gold]の[gold]支払い[/gold]を行う。[gold]レシート[/gold]1を得る。",
    ...
    private static readonly Dictionary<string, string> _cardsZhs = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "回合结束时，进行一次 [gold]{gold} 金币[/gold] [gold]还款[/gold]——若无力支付，失去 [b]{hp}[/b] 点生命，以血偿还。获得[gold]收据[/gold]1张。",
        ["WAGES_CARD.title"] = "工钱",
        ...
        ["BANKRUPTCY_CARD.description"] = "消耗你手中所有的[gold]债务[/gold]牌，获得等量[b]力量[/b]。获得[gold]破产[/gold]。",
            ...
            ["LEVERAGE_CARD.title"] = "杠杆",
                        ["SEIZED_GOODS_CARD.title"] = "扣押物",
            ["SEIZED_GOODS_CARD.description"] = "获得[b]{block}[/b]点格挡。\n根据剩余债务的多少，在战斗开始时洗入抽牌堆。",
            ["COLLATERAL_CARD.title"] = "抵押",
            ["COLLATERAL_CARD.description"] = "每欠下[gold]{per}金币[/gold]债务，获得[b]1[/b]点格挡。\n当前格挡[b]{amount}[/b]",
            ["DEFAULT_RISK_CARD.title"] = "违约风险",
            ["DEFAULT_RISK_CARD.description"] = "每欠下[gold]{per}金币[/gold]债务，获得[b]1[/b]点[b]力量[/b]。\n当前力量[b]{amount}[/b]",
            ["BAD_DEBT_CARD.title"] = "坏账",
            ["BAD_DEBT_CARD.description"] = "手牌中每有1张诅咒牌，造成[b]{per}[/b]点伤害。\n当前伤害[b]{amount}[/b]",
            ["LEVERAGE_CARD.description"] = "每欠下[gold]{per}金币[/gold]债务，造成[b]1[/b]点伤害。\n当前伤害[b]{amount}[/b]",
            ["RESTRUCTURING_CARD.title"] = "债务重组",
            ["RESTRUCTURING_CARD.description"] = "免除[gold]{cut} 金币[/gold]债务。\n每笔贷款仅限[b]1[/b]次。",
        ...
        ["BAILOUT_CARD.description"] = "替目标友方偿还 [gold]20 金币[/gold]的债务。该友方获得[gold]收据[/gold]1张。",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "失去 [b]{hp}[/b] 点生命，并进行一次 [gold]{pay} 金币[/gold] [gold]还款[/gold]。获得[gold]收据[/gold]1张。",
    ...
    private static readonly Dictionary<string, string> _cardsDeu = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "Am Ende deiner Runde leiste eine [gold]Zahlung[/gold] von [gold]{gold} Gold[/gold] — oder, wenn du sie dir nicht leisten kannst, verliere [b]{hp}[/b] LP und zahle mit Blut. Erhalte 1 [gold]Beleg[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Verbrauche jede [gold]Schuld[/gold]-Karte in deiner Hand und erhalte so viel [b]Stärke[/b]. Erhalte [gold]Insolvenz[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Hebelwirkung",
                        ["SEIZED_GOODS_CARD.title"] = "Pfandgut",
            ["SEIZED_GOODS_CARD.description"] = "Erhalte [b]{block}[/b] Block.\nWird zu Kampfbeginn je nach Höhe deiner Schulden in deinen Nachziehstapel gemischt.",
            ["COLLATERAL_CARD.title"] = "Sicherheit",
            ["COLLATERAL_CARD.description"] = "Erhalte [b]1[/b] Block pro [gold]{per} Gold[/gold] Schulden.\nDerzeit [b]{amount}[/b] Block",
            ["DEFAULT_RISK_CARD.title"] = "Ausfallrisiko",
            ["DEFAULT_RISK_CARD.description"] = "Erhalte [b]1[/b] Stärke pro [gold]{per} Gold[/gold] Schulden.\nDerzeit [b]{amount}[/b] Stärke",
            ["BAD_DEBT_CARD.title"] = "Faule Schuld",
            ["BAD_DEBT_CARD.description"] = "Verursache [b]{per}[/b] Schaden für jeden Fluch auf deiner Hand.\nDerzeit [b]{amount}[/b] Schaden",
            ["LEVERAGE_CARD.description"] = "Verursache [b]1[/b] Schaden pro [gold]{per} Gold[/gold] Schulden.\nDerzeit [b]{amount}[/b] Schaden",
            ["RESTRUCTURING_CARD.title"] = "Umschuldung",
            ["RESTRUCTURING_CARD.description"] = "Erlasse [gold]{cut} Gold[/gold] Schulden.\nNur [b]1[/b] Mal pro Darlehen.",
        ...
        ["BAILOUT_CARD.description"] = "Zahle [gold]20 Gold[/gold] auf die Schuld des gewählten Verbündeten. Dieser Verbündete erhält 1 [gold]Beleg[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Verliere [b]{hp}[/b] LP und leiste eine [gold]Zahlung[/gold] von [gold]{pay} Gold[/gold]. Erhalte 1 [gold]Beleg[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsFra = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "À la fin de ton tour, effectue un [gold]Paiement[/gold] de [gold]{gold} or[/gold] — ou, si tu ne peux pas payer, perds [b]{hp}[/b] PV et paie en sang. Gagne 1 [gold]Reçu[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Épuise toutes les cartes [gold]Dette[/gold] de ta main et gagne autant de [b]Force[/b]. Gagne [gold]Faillite[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Effet de levier",
                        ["SEIZED_GOODS_CARD.title"] = "Bien saisi",
            ["SEIZED_GOODS_CARD.description"] = "Gagnez [b]{block}[/b] Blocage.\nMélangé dans ta pioche au début du combat, selon le montant de ta dette.",
            ["COLLATERAL_CARD.title"] = "Garantie",
            ["COLLATERAL_CARD.description"] = "Gagnez [b]1[/b] Blocage par [gold]{per} Or[/gold] de dette.\nActuellement [b]{amount}[/b] Blocage",
            ["DEFAULT_RISK_CARD.title"] = "Risque de défaut",
            ["DEFAULT_RISK_CARD.description"] = "Gagnez [b]1[/b] Force par [gold]{per} Or[/gold] de dette.\nActuellement [b]{amount}[/b] Force",
            ["BAD_DEBT_CARD.title"] = "Créance douteuse",
            ["BAD_DEBT_CARD.description"] = "Infligez [b]{per}[/b] dégâts pour chaque Malédiction dans votre main.\nActuellement [b]{amount}[/b] dégâts",
            ["LEVERAGE_CARD.description"] = "Infligez [b]1[/b] dégât par [gold]{per} Or[/gold] de dette.\nActuellement [b]{amount}[/b] dégâts",
            ["RESTRUCTURING_CARD.title"] = "Restructuration",
            ["RESTRUCTURING_CARD.description"] = "Effacez [gold]{cut} Or[/gold] de dette.\nUne seule fois par prêt.",
        ...
        ["BAILOUT_CARD.description"] = "Paie [gold]20 or[/gold] sur la dette de l'allié ciblé. Cet allié gagne 1 [gold]Reçu[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Perds [b]{hp}[/b] PV et effectue un [gold]Paiement[/gold] de [gold]{pay} or[/gold]. Gagne 1 [gold]Reçu[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsSpa = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "Al final de tu turno, haz un [gold]Pago[/gold] de [gold]{gold} de oro[/gold] — o, si no puedes pagarlo, pierde [b]{hp}[/b] de vida y paga con sangre. Gana 1 [gold]Recibo[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Agota todas las cartas de [gold]Deuda[/gold] de tu mano y gana esa cantidad de [b]Fuerza[/b]. Gana [gold]Bancarrota[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Apalancamiento",
                        ["SEIZED_GOODS_CARD.title"] = "Bien embargado",
            ["SEIZED_GOODS_CARD.description"] = "Gana [b]{block}[/b] de Bloqueo.\nSe baraja en tu mazo de robo al inicio del combate, según tu deuda.",
            ["COLLATERAL_CARD.title"] = "Garantía",
            ["COLLATERAL_CARD.description"] = "Gana [b]1[/b] de Bloqueo por cada [gold]{per} de Oro[/gold] de deuda.\nActualmente [b]{amount}[/b] de Bloqueo",
            ["DEFAULT_RISK_CARD.title"] = "Riesgo de impago",
            ["DEFAULT_RISK_CARD.description"] = "Gana [b]1[/b] de Fuerza por cada [gold]{per} de Oro[/gold] de deuda.\nActualmente [b]{amount}[/b] de Fuerza",
            ["BAD_DEBT_CARD.title"] = "Deuda incobrable",
            ["BAD_DEBT_CARD.description"] = "Inflige [b]{per}[/b] de daño por cada Maldición en tu mano.\nActualmente [b]{amount}[/b] de daño",
            ["LEVERAGE_CARD.description"] = "Inflige [b]1[/b] de daño por cada [gold]{per} de Oro[/gold] de deuda.\nActualmente [b]{amount}[/b] de daño",
            ["RESTRUCTURING_CARD.title"] = "Reestructuración",
            ["RESTRUCTURING_CARD.description"] = "Condona [gold]{cut} de Oro[/gold] de deuda.\nSolo [b]1[/b] vez por préstamo.",
        ...
        ["BAILOUT_CARD.description"] = "Paga [gold]20 de oro[/gold] de la deuda del aliado objetivo. Ese aliado gana 1 [gold]Recibo[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Pierde [b]{hp}[/b] de vida y haz un [gold]Pago[/gold] de [gold]{pay} de oro[/gold]. Gana 1 [gold]Recibo[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsIta = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "Alla fine del turno, effettua un [gold]Pagamento[/gold] di [gold]{gold} Oro[/gold] — oppure, se non puoi permettertelo, perdi [b]{hp}[/b] PV e paghi col sangue. Ottieni 1 [gold]Ricevuta[/gold].",
        ["WAGES_CARD.title"] = "Salario",
        ...
        ["BANKRUPTCY_CARD.description"] = "Consuma ogni carta [gold]Debito[/gold] nella tua mano e ottieni altrettanta [b]Forza[/b]. Ottieni [gold]Bancarotta[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Leva finanziaria",
                        ["SEIZED_GOODS_CARD.title"] = "Bene pignorato",
            ["SEIZED_GOODS_CARD.description"] = "Ottieni [b]{block}[/b] Blocco.\nMescolata nel mazzo di pesca a inizio combattimento, in base al tuo debito.",
            ["COLLATERAL_CARD.title"] = "Garanzia",
            ["COLLATERAL_CARD.description"] = "Ottieni [b]1[/b] Blocco ogni [gold]{per} Oro[/gold] di debito.\nAttualmente [b]{amount}[/b] Blocco",
            ["DEFAULT_RISK_CARD.title"] = "Rischio di insolvenza",
            ["DEFAULT_RISK_CARD.description"] = "Ottieni [b]1[/b] Forza ogni [gold]{per} Oro[/gold] di debito.\nAttualmente [b]{amount}[/b] Forza",
            ["BAD_DEBT_CARD.title"] = "Credito inesigibile",
            ["BAD_DEBT_CARD.description"] = "Infliggi [b]{per}[/b] danni per ogni Maledizione nella tua mano.\nAttualmente [b]{amount}[/b] danni",
            ["LEVERAGE_CARD.description"] = "Infliggi [b]1[/b] danno ogni [gold]{per} Oro[/gold] di debito.\nAttualmente [b]{amount}[/b] danni",
            ["RESTRUCTURING_CARD.title"] = "Ristrutturazione",
            ["RESTRUCTURING_CARD.description"] = "Condona [gold]{cut} Oro[/gold] di debito.\nSolo [b]1[/b] volta per prestito.",
        ...
        ["BAILOUT_CARD.description"] = "Paga [gold]20 Oro[/gold] del debito dell'alleato bersaglio. Quell'alleato ottiene 1 [gold]Ricevuta[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Perdi [b]{hp}[/b] PV ed effettua un [gold]Pagamento[/gold] di [gold]{pay} Oro[/gold]. Ottieni 1 [gold]Ricevuta[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsPol = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "Na końcu tury dokonaj [gold]Spłaty[/gold] [gold]{gold} złota[/gold] — lub, jeśli cię na nią nie stać, strać [b]{hp}[/b] PŻ i zapłać krwią. Zyskaj 1 [gold]Paragon[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Zużyj każdą kartę [gold]Długu[/gold] z ręki i zyskaj tyle [b]Siły[/b]. Zyskaj [gold]Bankructwo[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Dźwignia",
                        ["SEIZED_GOODS_CARD.title"] = "Zajęte mienie",
            ["SEIZED_GOODS_CARD.description"] = "Zyskaj [b]{block}[/b] Bloku.\nWtasowana do talii dobierania na początku walki, zależnie od wielkości długu.",
            ["COLLATERAL_CARD.title"] = "Zabezpieczenie",
            ["COLLATERAL_CARD.description"] = "Zyskaj [b]1[/b] Bloku za każde [gold]{per} Złota[/gold] długu.\nObecnie [b]{amount}[/b] Bloku",
            ["DEFAULT_RISK_CARD.title"] = "Ryzyko niewypłacalności",
            ["DEFAULT_RISK_CARD.description"] = "Zyskaj [b]1[/b] Siły za każde [gold]{per} Złota[/gold] długu.\nObecnie [b]{amount}[/b] Siły",
            ["BAD_DEBT_CARD.title"] = "Zły dług",
            ["BAD_DEBT_CARD.description"] = "Zadaj [b]{per}[/b] obrażeń za każdą Klątwę w twojej ręce.\nObecnie [b]{amount}[/b] obrażeń",
            ["LEVERAGE_CARD.description"] = "Zadaj [b]1[/b] obrażenie za każde [gold]{per} Złota[/gold] długu.\nObecnie [b]{amount}[/b] obrażeń",
            ["RESTRUCTURING_CARD.title"] = "Restrukturyzacja",
            ["RESTRUCTURING_CARD.description"] = "Umórz [gold]{cut} Złota[/gold] długu.\nTylko [b]1[/b] raz na pożyczkę.",
        ...
        ["BAILOUT_CARD.description"] = "Zapłać [gold]20 złota[/gold] na dług wybranego sojusznika. Ten sojusznik zyskuje 1 [gold]Paragon[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Strać [b]{hp}[/b] PŻ i dokonaj [gold]Spłaty[/gold] [gold]{pay} złota[/gold]. Zyskaj 1 [gold]Paragon[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsPtb = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "No fim do seu turno, faça um [gold]Pagamento[/gold] de [gold]{gold} de Ouro[/gold] — ou, se não puder pagar, perca [b]{hp}[/b] de Vida e pague com sangue. Ganhe 1 [gold]Recibo[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Consuma todas as cartas de [gold]Dívida[/gold] na sua mão e ganhe essa quantidade de [b]Força[/b]. Ganhe [gold]Falência[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Alavancagem",
                        ["SEIZED_GOODS_CARD.title"] = "Bem penhorado",
            ["SEIZED_GOODS_CARD.description"] = "Ganhe [b]{block}[/b] de Bloqueio.\nEmbaralhada no seu monte de compra no início do combate, conforme sua dívida.",
            ["COLLATERAL_CARD.title"] = "Garantia",
            ["COLLATERAL_CARD.description"] = "Ganhe [b]1[/b] de Bloqueio a cada [gold]{per} de Ouro[/gold] de dívida.\nAtualmente [b]{amount}[/b] de Bloqueio",
            ["DEFAULT_RISK_CARD.title"] = "Risco de inadimplência",
            ["DEFAULT_RISK_CARD.description"] = "Ganhe [b]1[/b] de Força a cada [gold]{per} de Ouro[/gold] de dívida.\nAtualmente [b]{amount}[/b] de Força",
            ["BAD_DEBT_CARD.title"] = "Dívida podre",
            ["BAD_DEBT_CARD.description"] = "Cause [b]{per}[/b] de dano para cada Maldição na sua mão.\nAtualmente [b]{amount}[/b] de dano",
            ["LEVERAGE_CARD.description"] = "Cause [b]1[/b] de dano a cada [gold]{per} de Ouro[/gold] de dívida.\nAtualmente [b]{amount}[/b] de dano",
            ["RESTRUCTURING_CARD.title"] = "Reestruturação",
            ["RESTRUCTURING_CARD.description"] = "Perdoe [gold]{cut} de Ouro[/gold] de dívida.\nApenas [b]1[/b] vez por empréstimo.",
        ...
        ["BAILOUT_CARD.description"] = "Pague [gold]20 de Ouro[/gold] da dívida do aliado alvo. Esse aliado ganha 1 [gold]Recibo[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Perca [b]{hp}[/b] de Vida e faça um [gold]Pagamento[/gold] de [gold]{pay} de Ouro[/gold]. Ganhe 1 [gold]Recibo[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsRus = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "В конце хода совершите [gold]Платёж[/gold] в [gold]{gold} золота[/gold] — или, если не можете себе этого позволить, потеряйте [b]{hp}[/b] здоровья и заплатите кровью. Получите 1 [gold]Чек[/gold].",
        ...
        ["BANKRUPTCY_CARD.description"] = "Истощите все карты [gold]Долга[/gold] в руке и получите столько же [b]Силы[/b]. Получите [gold]Банкротство[/gold].",
            ...
            ["LEVERAGE_CARD.title"] = "Кредитное плечо",
                        ["SEIZED_GOODS_CARD.title"] = "Изъятое имущество",
            ["SEIZED_GOODS_CARD.description"] = "Получите [b]{block}[/b] блока.\nВ начале боя замешивается в колоду добора в зависимости от размера долга.",
            ["COLLATERAL_CARD.title"] = "Залог",
            ["COLLATERAL_CARD.description"] = "Получите [b]1[/b] блока за каждые [gold]{per} золота[/gold] долга.\nСейчас [b]{amount}[/b] блока",
            ["DEFAULT_RISK_CARD.title"] = "Риск дефолта",
            ["DEFAULT_RISK_CARD.description"] = "Получите [b]1[/b] силы за каждые [gold]{per} золота[/gold] долга.\nСейчас [b]{amount}[/b] силы",
            ["BAD_DEBT_CARD.title"] = "Безнадёжный долг",
            ["BAD_DEBT_CARD.description"] = "Нанесите [b]{per}[/b] урона за каждое проклятие в вашей руке.\nСейчас [b]{amount}[/b] урона",
            ["LEVERAGE_CARD.description"] = "Нанесите [b]1[/b] урона за каждые [gold]{per} золота[/gold] долга.\nСейчас [b]{amount}[/b] урона",
            ["RESTRUCTURING_CARD.title"] = "Реструктуризация",
            ["RESTRUCTURING_CARD.description"] = "Списывает [gold]{cut} золота[/gold] долга.\nОдин раз за заём.",
        ...
        ["BAILOUT_CARD.description"] = "Заплатите [gold]20 золота[/gold] в счёт долга выбранного союзника. Этот союзник получает 1 [gold]Чек[/gold].",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "Потеряйте [b]{hp}[/b] здоровья и совершите [gold]Платёж[/gold] в [gold]{pay} золота[/gold]. Получите 1 [gold]Чек[/gold].",
    ...
    private static readonly Dictionary<string, string> _cardsTha = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "เมื่อจบเทิร์น ทำ[gold]การชำระ[/gold] [gold]{gold} ทอง[/gold] — หากจ่ายไม่ไหว เสียพลังชีวิต [b]{hp}[/b] และจ่ายด้วยเลือด รับ[gold]ใบเสร็จ[/gold] 1",
        ...
        ["BANKRUPTCY_CARD.description"] = "เผาผลาญการ์ด[gold]หนี้[/gold]ทุกใบในมือ และรับ[b]พลัง[/b]เท่าจำนวนนั้น รับ[gold]ล้มละลาย[/gold]",
            ...
            ["LEVERAGE_CARD.title"] = "เลเวอเรจ",
                        ["SEIZED_GOODS_CARD.title"] = "ทรัพย์ที่ถูกยึด",
            ["SEIZED_GOODS_CARD.description"] = "รับ [b]{block}[/b] บล็อก\nสับเข้ากองจั่วเมื่อเริ่มต่อสู้ ตามขนาดหนี้ที่ค้างอยู่",
            ["COLLATERAL_CARD.title"] = "หลักประกัน",
            ["COLLATERAL_CARD.description"] = "รับ [b]1[/b] บล็อกต่อหนี้ทุก [gold]{per} ทอง[/gold]\nตอนนี้ [b]{amount}[/b] บล็อก",
            ["DEFAULT_RISK_CARD.title"] = "ความเสี่ยงผิดนัดชำระ",
            ["DEFAULT_RISK_CARD.description"] = "รับ [b]1[/b] พลังต่อหนี้ทุก [gold]{per} ทอง[/gold]\nตอนนี้ [b]{amount}[/b] พลัง",
            ["BAD_DEBT_CARD.title"] = "หนี้เสีย",
            ["BAD_DEBT_CARD.description"] = "สร้างความเสียหาย [b]{per}[/b] ต่อการ์ดคำสาปแต่ละใบในมือ\nตอนนี้ [b]{amount}[/b] ความเสียหาย",
            ["LEVERAGE_CARD.description"] = "สร้างความเสียหาย [b]1[/b] ต่อหนี้ทุก [gold]{per} ทอง[/gold]\nตอนนี้ [b]{amount}[/b] ความเสียหาย",
            ["RESTRUCTURING_CARD.title"] = "ปรับโครงสร้างหนี้",
            ["RESTRUCTURING_CARD.description"] = "ยกหนี้ [gold]{cut} ทอง[/gold]\nใช้ได้ [b]1[/b] ครั้งต่อการกู้",
        ...
        ["BAILOUT_CARD.description"] = "จ่าย [gold]20 ทอง[/gold] เพื่อลดหนี้ของพันธมิตรเป้าหมาย พันธมิตรนั้นได้รับ[gold]ใบเสร็จ[/gold] 1",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "เสียพลังชีวิต [b]{hp}[/b] และทำ[gold]การชำระ[/gold] [gold]{pay} ทอง[/gold] รับ[gold]ใบเสร็จ[/gold] 1",
    ...
    private static readonly Dictionary<string, string> _cardsTur = new()
    {
        ...
        ["DEBTOR_CARD.description"] = "Turunun sonunda [gold]{gold} Altın[/gold] [gold]Ödeme[/gold] yap — ya da ödeyemezsen [b]{hp}[/b] Can kaybet ve kanla öde. 1 [gold]Makbuz[/gold] kazan.",
        ...
        ["BANKRUPTCY_CARD.description"] = "Elindeki tüm [gold]Borç[/gold] kartlarını tüket ve o kadar [b]Güç[/b] kazan. [gold]İflas[/gold] kazan.",
            ...
            ["LEVERAGE_CARD.title"] = "Kaldıraç",
                        ["SEIZED_GOODS_CARD.title"] = "El konulan mal",
            ["SEIZED_GOODS_CARD.description"] = "[b]{block}[/b] Blok kazan.\nSavaş başında, borcunun büyüklüğüne göre çekme destene karıştırılır.",
            ["COLLATERAL_CARD.title"] = "Teminat",
            ["COLLATERAL_CARD.description"] = "Her [gold]{per} Altın[/gold] borç için [b]1[/b] Blok kazan.\nŞu an [b]{amount}[/b] Blok",
            ["DEFAULT_RISK_CARD.title"] = "Temerrüt Riski",
            ["DEFAULT_RISK_CARD.description"] = "Her [gold]{per} Altın[/gold] borç için [b]1[/b] Güç kazan.\nŞu an [b]{amount}[/b] Güç",
            ["BAD_DEBT_CARD.title"] = "Batık Alacak",
            ["BAD_DEBT_CARD.description"] = "Elindeki her Lanet için [b]{per}[/b] hasar ver.\nŞu an [b]{amount}[/b] hasar",
            ["LEVERAGE_CARD.description"] = "Her [gold]{per} Altın[/gold] borç için [b]1[/b] hasar ver.\nŞu an [b]{amount}[/b] hasar",
            ["RESTRUCTURING_CARD.title"] = "Borç Yapılandırma",
            ["RESTRUCTURING_CARD.description"] = "Borçtan [gold]{cut} Altın[/gold] sil.\nKredi başına yalnızca [b]1[/b] kez.",
        ...
        ["BAILOUT_CARD.description"] = "Hedeflenen müttefikin borcuna [gold]20 Altın[/gold] öde. O müttefik 1 [gold]Makbuz[/gold] kazanır.",
        ...
        ["BLOOD_PAYMENT_CARD.description"] = "[b]{hp}[/b] Can kaybet ve [gold]{pay} Altın[/gold] [gold]Ödeme[/gold] yap. 1 [gold]Makbuz[/gold] kazan.",
