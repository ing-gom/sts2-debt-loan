...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, RewardUiRow> RewardUiByLang = new()
    {
        ...
        ["kor"] = new("수령", "신용 보상", "신용 회복 카드", "그 카드를 강화", "덱의 카드 1장 강화", "덱의 카드 1장 제거", "수령함", "수령 가능", "{0} 골드 남음", "카드 제거", "빚 {0}으로 덱에서 카드 1장을 제거합니다. 상인의 제거 가격도 같이 오릅니다.", "제거할 카드가 없습니다.", "강화", "제거", "이후 신용도 {0}마다 번갈아 끝없이: 카드 제거 → 강화 → 제거 …"),
