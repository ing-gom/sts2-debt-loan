...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, string> _cardsEng = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Deal [b]{Damage}[/b] damage to ALL enemies [b]{CalculatedHits}[/b] times — once, plus once per [b]Receipt[/b] you hold. Spends all your [b]Receipts[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsKor = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "모든 적에게 [b]{Damage}[/b]의 피해를 [b]{CalculatedHits}[/b]번 줍니다 — 기본 1타에 보유한 [b]영수증[/b] 1개당 1타를 더합니다. [b]영수증[/b]을 전부 소비합니다.",
    ...
    private static readonly Dictionary<string, string> _cardsJpn = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "すべての敵に[b]{Damage}[/b]のダメージを[b]{CalculatedHits}[/b]回与える — 1回に加えて、所持している[b]レシート[/b]1枚につき1回。[b]レシート[/b]をすべて消費する。",
    ...
    private static readonly Dictionary<string, string> _cardsZhs = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "对所有敌人造成 [b]{Damage}[/b] 点伤害，共 [b]{CalculatedHits}[/b] 次——一次，外加你持有的每张[b]收据[/b]再打一次。消耗你所有的[b]收据[/b]。",
    ...
    private static readonly Dictionary<string, string> _cardsDeu = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Füge allen Gegnern [b]{Damage}[/b] Schaden [b]{CalculatedHits}[/b]-mal zu — einmal, plus einmal pro [b]Beleg[/b], den du hältst. Verbraucht all deine [b]Belege[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsFra = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Inflige [b]{Damage}[/b] dégâts à tous les ennemis [b]{CalculatedHits}[/b] fois — une fois, plus une fois par [b]reçu[/b] que tu possèdes. Dépense tous tes [b]reçus[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsSpa = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Inflige [b]{Damage}[/b] de daño a todos los enemigos [b]{CalculatedHits}[/b] veces — una vez, más una vez por cada [b]recibo[/b] que tengas. Gasta todos tus [b]recibos[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsIta = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Infliggi [b]{Damage}[/b] danni a tutti i nemici [b]{CalculatedHits}[/b] volte — una volta, più una volta per ogni [b]ricevuta[/b] che possiedi. Consuma tutte le tue [b]ricevute[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsPol = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Zadaj [b]{Damage}[/b] obrażeń wszystkim wrogom [b]{CalculatedHits}[/b] razy — raz, plus raz za każdy posiadany [b]paragon[/b]. Zużywa wszystkie twoje [b]paragony[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsPtb = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Cause [b]{Damage}[/b] de dano a todos os inimigos [b]{CalculatedHits}[/b] vezes — uma vez, mais uma vez por [b]recibo[/b] que você possui. Gasta todos os seus [b]recibos[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsRus = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Нанесите [b]{Damage}[/b] урона всем врагам [b]{CalculatedHits}[/b] раз — один раз, плюс ещё раз за каждый имеющийся [b]чек[/b]. Тратит все ваши [b]чеки[/b].",
    ...
    private static readonly Dictionary<string, string> _cardsTha = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "สร้างความเสียหาย [b]{Damage}[/b] แก่ศัตรูทั้งหมด จำนวน [b]{CalculatedHits}[/b] ครั้ง — หนึ่งครั้ง บวกอีกหนึ่งครั้งต่อ[b]ใบเสร็จ[/b]ที่คุณถืออยู่แต่ละใบ ใช้[b]ใบเสร็จ[/b]ทั้งหมดของคุณ",
    ...
    private static readonly Dictionary<string, string> _cardsTur = new()
    {
        ...
        ["GARNISHMENT_CARD.description"] = "Tüm düşmanlara [b]{Damage}[/b] hasarı [b]{CalculatedHits}[/b] kez ver — bir kez, artı elinde tuttuğun her [b]makbuz[/b] için bir kez daha. Tüm [b]makbuzlarını[/b] harcar.",
