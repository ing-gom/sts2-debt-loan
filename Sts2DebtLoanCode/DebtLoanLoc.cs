...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, string> _cardsEng = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Exhaust every [gold]Debt[/gold] card you hold and gain that much [b]Strength[/b]. Gain [gold]Bankruptcy[/gold] — you can't gain Gold this combat.",
    ...
    private static readonly Dictionary<string, string> _cardsKor = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "보유한 [gold]빚[/gold] 카드를 모두 소멸시키고 그 수만큼 힘을 얻습니다. [gold]파산[/gold] 부여 — 이번 전투에 골드를 얻을 수 없습니다.",
    ...
    private static readonly Dictionary<string, string> _powersEng = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Can't gain Gold.",
    ...
    private static readonly Dictionary<string, string> _powersKor = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "골드를 얻을 수 없습니다.",
    ...
    private static readonly Dictionary<string, string> _cardsJpn = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "手札の[gold]借金[/gold]カードをすべて消耗し、その枚数分の[b]筋力[/b]を得る。[gold]破産[/gold]を得る——この戦闘中ゴールドを得られない。",
    ...
    private static readonly Dictionary<string, string> _cardsZhs = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "消耗你手中所有的[gold]债务[/gold]牌，获得等量[b]力量[/b]。获得[gold]破产[/gold]——本次战斗无法获得金币。",
    ...
    private static readonly Dictionary<string, string> _cardsDeu = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Verbrauche jede [gold]Schuld[/gold]-Karte in deiner Hand und erhalte so viel [b]Stärke[/b]. Erhalte [gold]Insolvenz[/gold] — du kannst in diesem Kampf kein Gold erhalten.",
    ...
    private static readonly Dictionary<string, string> _cardsFra = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Épuise toutes les cartes [gold]Dette[/gold] de ta main et gagne autant de [b]Force[/b]. Gagne [gold]Faillite[/gold] — tu ne peux pas gagner d'or ce combat.",
    ...
    private static readonly Dictionary<string, string> _cardsSpa = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Agota todas las cartas de [gold]Deuda[/gold] de tu mano y gana esa cantidad de [b]Fuerza[/b]. Gana [gold]Bancarrota[/gold]: no puedes ganar oro este combate.",
    ...
    private static readonly Dictionary<string, string> _cardsIta = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Consuma ogni carta [gold]Debito[/gold] nella tua mano e ottieni altrettanta [b]Forza[/b]. Ottieni [gold]Bancarotta[/gold] — non puoi ottenere Oro in questo combattimento.",
    ...
    private static readonly Dictionary<string, string> _cardsPol = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Zużyj każdą kartę [gold]Długu[/gold] z ręki i zyskaj tyle [b]Siły[/b]. Zyskaj [gold]Bankructwo[/gold] — w tej walce nie możesz zdobyć złota.",
    ...
    private static readonly Dictionary<string, string> _cardsPtb = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Consuma todas as cartas de [gold]Dívida[/gold] na sua mão e ganhe essa quantidade de [b]Força[/b]. Ganhe [gold]Falência[/gold] — você não pode ganhar Ouro neste combate.",
    ...
    private static readonly Dictionary<string, string> _cardsRus = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Истощите все карты [gold]Долга[/gold] в руке и получите столько же [b]Силы[/b]. Получите [gold]Банкротство[/gold] — в этом бою нельзя получать золото.",
    ...
    private static readonly Dictionary<string, string> _cardsTha = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "เผาผลาญการ์ด[gold]หนี้[/gold]ทุกใบในมือ และรับ[b]พลัง[/b]เท่าจำนวนนั้น รับ[gold]ล้มละลาย[/gold] — รับทองไม่ได้ในการต่อสู้นี้",
    ...
    private static readonly Dictionary<string, string> _cardsTur = new()
    {
        ...
        ["BANKRUPTCY_CARD.description"] = "Elindeki tüm [gold]Borç[/gold] kartlarını tüket ve o kadar [b]Güç[/b] kazan. [gold]İflas[/gold] kazan — bu savaşta Altın kazanamazsın.",
    ...
    private static readonly Dictionary<string, string> _powersJpn = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "ゴールドを得られない。",
    ...
    private static readonly Dictionary<string, string> _powersZhs = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "无法获得金币。",
    ...
    private static readonly Dictionary<string, string> _powersDeu = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Kann kein Gold erhalten.",
    ...
    private static readonly Dictionary<string, string> _powersFra = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Ne peut pas gagner d'or.",
    ...
    private static readonly Dictionary<string, string> _powersSpa = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "No puedes ganar oro.",
    ...
    private static readonly Dictionary<string, string> _powersIta = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Non puoi ottenere Oro.",
    ...
    private static readonly Dictionary<string, string> _powersPol = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Nie możesz zdobywać złota.",
    ...
    private static readonly Dictionary<string, string> _powersPtb = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Não pode ganhar Ouro.",
    ...
    private static readonly Dictionary<string, string> _powersRus = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Нельзя получать золото.",
    ...
    private static readonly Dictionary<string, string> _powersTha = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "รับทองไม่ได้",
    ...
    private static readonly Dictionary<string, string> _powersTur = new()
    {
        ...
        ["BANKRUPTCY_POWER.description"] = "Altın kazanamazsın.",
