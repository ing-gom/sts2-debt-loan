...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, Row> ByLang = new()
    {
        ["eng"] = new("Debt Ledger",
            ...
            "Payment", "Pay [gold]{play} Gold[/gold] toward your debt if you can afford it (all or nothing). Gain a [gold]Receipt[/gold] — [gold]2[/gold] if you paid. Playable even when broke.",
        ...
        ["kor"] = new("빚 장부",
            ...
            "모든 서명은 작은 항복이다.",
            "납부", "골드가 있으면 [gold]{play} 골드[/gold]를 빚에 [gold]납부[/gold](없으면 소모 없음). [gold]영수증[/gold] 1장, 납부 시 [gold]1장[/gold] 더. 무일푼에도 사용 가능.",
        ...
        ["jpn"] = new("借金台帳",
            ...
            "署名はすべて、小さな降伏だ。",
            "支払い", "ゴールドがあれば[gold]{play} ゴールド[/gold]返済（無ければ消費なし）。[gold]レシート[/gold]1枚、支払えば[gold]2枚[/gold]。無一文でも使用可。",
        ...
        ["zhs"] = new("债务账簿",
            ...
            "每一个签名都是一次小小的屈服。",
            "还款", "若有金币则偿还 [gold]{play} 金币[/gold]债务（不足则不消耗）。获得[gold]收据[/gold]1张，已支付则[gold]2张[/gold]。没钱也能打出。",
        ...
        ["deu"] = new("Schuldenbuch",
            ...
            "Zahlung", "Zahle [gold]{play} Gold[/gold] auf deine Schuld, wenn du es dir leisten kannst (ganz oder gar nicht). Erhalte einen [gold]Beleg[/gold] — [gold]2[/gold], wenn du gezahlt hast. Auch ohne Gold spielbar.",
        ...
        ["fra"] = new("Grand livre des dettes",
            ...
            "Paiement", "Paie [gold]{play} or[/gold] de ta dette si tu peux te le permettre (tout ou rien). Gagne un [gold]Reçu[/gold] — [gold]2[/gold] si tu as payé. Jouable même sans or.",
        ...
        ["spa"] = new("Libro de deudas",
            ...
            "Pago", "Paga [gold]{play} de oro[/gold] de tu deuda si puedes permitírtelo (todo o nada). Obtén un [gold]Recibo[/gold] — [gold]2[/gold] si pagaste. Jugable incluso sin oro.",
        ...
        ["ita"] = new("Registro dei debiti",
            ...
            "Pagamento", "Paga [gold]{play} Oro[/gold] del debito se puoi permettertelo (tutto o niente). Ottieni una [gold]Ricevuta[/gold] — [gold]2[/gold] se hai pagato. Giocabile anche senz'oro.",
        ...
        ["pol"] = new("Księga długów",
            ...
            "Spłata", "Spłać [gold]{play} złota[/gold] długu, jeśli cię na to stać (wszystko albo nic). Zdobądź [gold]Paragon[/gold] — [gold]2[/gold], jeśli zapłacisz. Grywalne nawet bez złota.",
        ...
        ["ptb"] = new("Livro-razão de dívidas",
            ...
            "Pagamento", "Pague [gold]{play} de Ouro[/gold] da dívida se puder (tudo ou nada). Ganhe um [gold]Recibo[/gold] — [gold]2[/gold] se pagou. Jogável mesmo sem ouro.",
        ...
        ["rus"] = new("Долговая книга",
            ...
            "Платёж", "Выплатите [gold]{play} золота[/gold] долга, если хватает (всё или ничего). Получите [gold]Чек[/gold] — [gold]2[/gold], если заплатили. Можно даже без золота.",
        ...
        ["tha"] = new("บัญชีหนี้",
            ...
            "การชำระ", "ถ้ามีทองชำระหนี้ [gold]{play} ทอง[/gold] (ไม่พอจะไม่เสีย) รับ[gold]ใบเสร็จ[/gold] 1 (ถ้าจ่ายรับ [gold]2[/gold]) เล่นได้แม้ไม่มีทอง",
        ...
        ["tur"] = new("Borç Defteri",
            ...
            "Ödeme", "Karşılayabiliyorsan borcuna [gold]{play} Altın[/gold] öde (ya hep ya hiç). Bir [gold]Makbuz[/gold] kazan — ödediysen [gold]2[/gold]. Altının olmasa bile oynanır.",
