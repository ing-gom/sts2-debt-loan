...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, Row> ByLang = new()
    {
        ["eng"] = new("Debt Ledger",
            ...
            "Payment", "Pay up to [gold]{play} Gold[/gold] toward your debt. Gain a [gold]Receipt[/gold] — [gold]2[/gold] if you paid any gold. Playable even when broke.",
        ...
        ["kor"] = new("빚 장부",
            ...
            "모든 서명은 작은 항복이다.",
            "납부", "빚에 최대 [gold]{play} 골드[/gold] [gold]납부[/gold]. [gold]영수증[/gold] 1장을 얻고, 골드를 냈다면 [gold]1장[/gold] 더. 무일푼에도 사용 가능.",
        ...
        ["jpn"] = new("借金台帳",
            ...
            "署名はすべて、小さな降伏だ。",
            "支払い", "借金に最大[gold]{play} ゴールド[/gold]返済。[gold]レシート[/gold]を1枚（ゴールドを払えば[gold]2枚[/gold]）得る。無一文でも使用可。",
        ...
        ["zhs"] = new("债务账簿",
            ...
            "每一个签名都是一次小小的屈服。",
            "还款", "最多偿还 [gold]{play} 金币[/gold]债务。获得一张[gold]收据[/gold]（若支付了金币则获得[gold]2张[/gold]）。没钱也能打出。",
        ...
        ["deu"] = new("Schuldenbuch",
            ...
            "Zahlung", "Zahle bis zu [gold]{play} Gold[/gold] auf deine Schuld. Erhalte einen [gold]Beleg[/gold] — [gold]2[/gold], wenn du Gold gezahlt hast. Auch ohne Gold spielbar.",
        ...
        ["fra"] = new("Grand livre des dettes",
            ...
            "Paiement", "Paie jusqu'à [gold]{play} or[/gold] de ta dette. Gagne un [gold]Reçu[/gold] — [gold]2[/gold] si tu as payé de l'or. Jouable même sans or.",
        ...
        ["spa"] = new("Libro de deudas",
            ...
            "Pago", "Paga hasta [gold]{play} de oro[/gold] de tu deuda. Obtén un [gold]Recibo[/gold] — [gold]2[/gold] si pagaste algo de oro. Jugable incluso sin oro.",
        ...
        ["ita"] = new("Registro dei debiti",
            ...
            "Pagamento", "Paga fino a [gold]{play} Oro[/gold] del debito. Ottieni una [gold]Ricevuta[/gold] — [gold]2[/gold] se hai pagato oro. Giocabile anche senz'oro.",
        ...
        ["pol"] = new("Księga długów",
            ...
            "Spłata", "Spłać do [gold]{play} złota[/gold] długu. Zdobądź [gold]Paragon[/gold] — [gold]2[/gold], jeśli zapłacisz złotem. Grywalne nawet bez złota.",
        ...
        ["ptb"] = new("Livro-razão de dívidas",
            ...
            "Pagamento", "Pague até [gold]{play} de Ouro[/gold] da dívida. Ganhe um [gold]Recibo[/gold] — [gold]2[/gold] se pagou algum ouro. Jogável mesmo sem ouro.",
        ...
        ["rus"] = new("Долговая книга",
            ...
            "Платёж", "Выплатите до [gold]{play} золота[/gold] долга. Получите [gold]Чек[/gold] — [gold]2[/gold], если заплатили золотом. Можно даже без золота.",
        ...
        ["tha"] = new("บัญชีหนี้",
            ...
            "การชำระ", "ชำระหนี้สูงสุด [gold]{play} ทอง[/gold] รับ[gold]ใบเสร็จ[/gold] 1 (ถ้าจ่ายทองรับ [gold]2[/gold]) เล่นได้แม้ไม่มีทอง",
        ...
        ["tur"] = new("Borç Defteri",
            ...
            "Ödeme", "Borcuna en fazla [gold]{play} Altın[/gold] öde. Bir [gold]Makbuz[/gold] kazan — altın ödediysen [gold]2[/gold]. Altının olmasa bile oynanır.",
