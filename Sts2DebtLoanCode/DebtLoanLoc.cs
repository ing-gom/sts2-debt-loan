...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, Row> ByLang = new()
    {
        ["eng"] = new("Merchant's Ledger",
            ...
            "Bad Credit", "The instant it reaches your hand you gain [gold]Bad Credit[/gold], then vanishes — a [gold]Debtor[/gold] card is added to your hand each turn, growing stronger every 3rd turn.",
        ...
        ["kor"] = new("상인의 장부",
            ...
            "신용 불량", "손에 들어오는 즉시 [gold]신용 불량[/gold] 상태가 되고 사라집니다 — 이후 매 턴 [gold]빚쟁이[/gold] 카드가 손에 추가되며, 3턴마다 강해집니다.",
        ...
        ["jpn"] = new("商人の元帳",
            ...
            "信用不良", "手札に入った瞬間[gold]信用不良[/gold]になって消滅する — 以降毎ターン[gold]借金取り[/gold]カードが手札に加わり、3ターンごとに強くなる。",
        ...
        ["zhs"] = new("商人的账簿",
            ...
            "信用不良", "进入手牌的瞬间获得[gold]信用不良[/gold]并消失——此后每回合将一张[gold]讨债人[/gold]牌加入手牌，每3回合变强。",
        ...
        ["deu"] = new("Händlerbuch",
            ...
            "Zahlungsunfähig", "Sobald sie auf deine Hand kommt, erhältst du [gold]Zahlungsunfähig[/gold] und sie verschwindet — danach kommt jede Runde eine [gold]Schuldeneintreiber[/gold]-Karte auf deine Hand, alle 3 Runden stärker.",
        ...
        ["fra"] = new("Grand livre du marchand",
            ...
            "Insolvabilité", "Dès qu'elle arrive en main, tu gagnes [gold]Insolvabilité[/gold] et elle disparaît — ensuite une carte [gold]Créancier[/gold] est ajoutée à ta main chaque tour, plus forte tous les 3 tours.",
        ...
        ["spa"] = new("Libro del mercader",
            ...
            "Insolvencia", "En cuanto llega a tu mano obtienes [gold]Insolvencia[/gold] y desaparece — después cada turno se añade una carta de [gold]Cobrador[/gold] a tu mano, más fuerte cada 3 turnos.",
        ...
        ["ita"] = new("Registro del mercante",
            ...
            "Insolvenza", "Appena arriva in mano ottieni [gold]Insolvenza[/gold] e svanisce — poi ogni turno una carta [gold]Esattore[/gold] viene aggiunta alla tua mano, più forte ogni 3 turni.",
        ...
        ["pol"] = new("Księga kupca",
            ...
            "Niewypłacalność", "Gdy trafi do ręki, zyskujesz [gold]Niewypłacalność[/gold] i znika — potem co turę do ręki trafia karta [gold]Windykator[/gold], silniejsza co 3 tury.",
        ...
        ["ptb"] = new("Livro-razão do mercador",
            ...
            "Crédito Ruim", "Assim que chega à sua mão você ganha [gold]Crédito Ruim[/gold] e ela some — depois uma carta de [gold]Cobrador[/gold] é adicionada à sua mão a cada turno, mais forte a cada 3 turnos.",
        ...
        ["rus"] = new("Гроссбух торговца",
            ...
            "Неплатёжеспособность", "Как только попадает в руку, вы получаете [gold]Неплатёжеспособность[/gold] и она исчезает — затем каждый ход в руку добавляется карта [gold]Долговой сборщик[/gold], усиливаясь каждый 3-й ход.",
        ...
        ["tha"] = new("บัญชีของพ่อค้า",
            ...
            "เครดิตเสีย", "ทันทีที่เข้ามือ คุณจะได้รับ[gold]เครดิตเสีย[/gold]แล้วหายไป — จากนั้นทุกเทิร์นจะเพิ่มการ์ด[gold]เจ้าหนี้[/gold]เข้ามือ แข็งแกร่งขึ้นทุก 3 เทิร์น",
        ...
        ["tur"] = new("Tüccarın Defteri",
            ...
            "Kredi İflası", "Eline geldiği anda [gold]Kredi İflası[/gold] kazanır ve kaybolur — sonra her tur eline bir [gold]Tahsildar[/gold] kartı eklenir, her 3 turda güçlenir.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Debtor",
        ["DEBTOR_CARD.description"] = "Make a [gold]{gold} Gold[/gold] [gold]Payment[/gold].\nIf still in hand at end of turn, lose [b]{hp}[/b] HP and make the Payment anyway.",
    ...
    {
        ["DEBTOR_CARD.title"] = "빚쟁이",
        ["DEBTOR_CARD.description"] = "[gold]{gold} 골드[/gold]를 [gold]납부[/gold]합니다.\n턴 종료 시 손에 남아있으면 체력 [b]{hp}[/b]을 잃고 그래도 납부합니다.",
        ["WAGES_CARD.title"] = "품삯",
    ...
    private static readonly Dictionary<string, string> _powersEng = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "At the start of each turn, add a Debtor card to your hand. Every 3rd turn it grows stronger.",
    ...
    private static readonly Dictionary<string, string> _powersKor = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "매 턴 시작 시 빚쟁이 카드를 손에 넣습니다. 3턴마다 더 강해집니다.",
    ...
    {
        ["DEBTOR_CARD.title"] = "借金取り",
        ["DEBTOR_CARD.description"] = "[gold]{gold} ゴールド[/gold]の[gold]支払い[/gold]を行う。\nターン終了時に手札に残っていると、体力を [b]{hp}[/b] 失い、それでも支払いを行う。",
        ["WAGES_CARD.title"] = "賃金",
        ["WAGES_CARD.description"] = "[gold]{gold} ゴールド[/gold]を得る。",
        ["JOB_PLACEMENT_CARD.title"] = "職業紹介",
        ["JOB_PLACEMENT_CARD.description"] = "[gold]{fee} ゴールド[/gold]を借金として借りる。\n各ターン開始時、[gold]賃金[/gold]カードを手札に加える。",
    ...
    {
        ["DEBTOR_CARD.title"] = "讨债人",
        ["DEBTOR_CARD.description"] = "进行一次 [gold]{gold} 金币[/gold] [gold]还款[/gold]。\n回合结束时若仍在手牌中，失去 [b]{hp}[/b] 点生命并仍然还款。",
        ["WAGES_CARD.title"] = "工钱",
        ["WAGES_CARD.description"] = "获得 [gold]{gold} 金币[/gold]。",
        ["JOB_PLACEMENT_CARD.title"] = "就业安置",
        ["JOB_PLACEMENT_CARD.description"] = "借入 [gold]{fee} 金币[/gold]计入你的贷款。\n每回合开始时，将一张[gold]工钱[/gold]牌加入手牌。",
    ...
    {
        ["DEBTOR_CARD.title"] = "Schuldeneintreiber",
        ["DEBTOR_CARD.description"] = "Leiste eine [gold]Zahlung[/gold] von [gold]{gold} Gold[/gold].\nIst sie am Rundenende noch auf der Hand, verlierst du [b]{hp}[/b] LP und leistest die Zahlung trotzdem.",
        ["WAGES_CARD.title"] = "Lohn",
        ["WAGES_CARD.description"] = "Erhalte [gold]{gold} Gold[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Arbeitsvermittlung",
        ["JOB_PLACEMENT_CARD.description"] = "Leihe [gold]{fee} Gold[/gold] auf deine Schuld.\nLege zu Beginn jeder Runde eine [gold]Lohn[/gold]-Karte auf deine Hand.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Créancier",
        ["DEBTOR_CARD.description"] = "Effectue un [gold]Paiement[/gold] de [gold]{gold} or[/gold].\nSi elle est encore en main en fin de tour, perds [b]{hp}[/b] PV et effectue quand même le Paiement.",
        ["WAGES_CARD.title"] = "Salaire",
        ["WAGES_CARD.description"] = "Gagne [gold]{gold} or[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Placement",
        ["JOB_PLACEMENT_CARD.description"] = "Emprunte [gold]{fee} or[/gold] sur ta dette.\nAu début de chaque tour, ajoute une carte [gold]Salaire[/gold] à ta main.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Cobrador",
        ["DEBTOR_CARD.description"] = "Haz un [gold]Pago[/gold] de [gold]{gold} de oro[/gold].\nSi sigue en tu mano al final del turno, pierde [b]{hp}[/b] de vida y haz el Pago de todos modos.",
        ["WAGES_CARD.title"] = "Salario",
        ["WAGES_CARD.description"] = "Gana [gold]{gold} de oro[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Colocación laboral",
        ["JOB_PLACEMENT_CARD.description"] = "Toma prestado [gold]{fee} de oro[/gold] sobre tu deuda.\nAl inicio de cada turno, añade una carta de [gold]Salario[/gold] a tu mano.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Esattore",
        ["DEBTOR_CARD.description"] = "Effettua un [gold]Pagamento[/gold] di [gold]{gold} Oro[/gold].\nSe è ancora in mano a fine turno, perdi [b]{hp}[/b] PV ed effettua comunque il Pagamento.",
        ["WAGES_CARD.title"] = "Salario",
        ["WAGES_CARD.description"] = "Ottieni [gold]{gold} Oro[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Collocamento",
        ["JOB_PLACEMENT_CARD.description"] = "Prendi in prestito [gold]{fee} Oro[/gold] sul tuo debito.\nAll'inizio di ogni turno, aggiungi una carta [gold]Salario[/gold] alla tua mano.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Windykator",
        ["DEBTOR_CARD.description"] = "Dokonaj [gold]Spłaty[/gold] [gold]{gold} złota[/gold].\nJeśli pozostanie w ręce na końcu tury, strać [b]{hp}[/b] PŻ i mimo to dokonaj Spłaty.",
        ["WAGES_CARD.title"] = "Wypłata",
        ["WAGES_CARD.description"] = "Zyskaj [gold]{gold} złota[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Pośrednictwo pracy",
        ["JOB_PLACEMENT_CARD.description"] = "Pożycz [gold]{fee} złota[/gold] do swojego długu.\nNa początku każdej tury dodaj kartę [gold]Wypłata[/gold] do ręki.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Cobrador",
        ["DEBTOR_CARD.description"] = "Faça um [gold]Pagamento[/gold] de [gold]{gold} de Ouro[/gold].\nSe ainda estiver na mão no fim do turno, perca [b]{hp}[/b] de Vida e faça o Pagamento mesmo assim.",
        ["WAGES_CARD.title"] = "Salário",
        ["WAGES_CARD.description"] = "Ganhe [gold]{gold} de Ouro[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Colocação",
        ["JOB_PLACEMENT_CARD.description"] = "Pegue [gold]{fee} de Ouro[/gold] emprestado na sua dívida.\nNo início de cada turno, adicione uma carta de [gold]Salário[/gold] à sua mão.",
    ...
    {
        ["DEBTOR_CARD.title"] = "Долговой сборщик",
        ["DEBTOR_CARD.description"] = "Совершите [gold]Платёж[/gold] в [gold]{gold} золота[/gold].\nЕсли она ещё в руке в конце хода, потеряйте [b]{hp}[/b] здоровья и всё равно совершите Платёж.",
        ["WAGES_CARD.title"] = "Зарплата",
        ["WAGES_CARD.description"] = "Получите [gold]{gold} золота[/gold].",
        ["JOB_PLACEMENT_CARD.title"] = "Трудоустройство",
        ["JOB_PLACEMENT_CARD.description"] = "Возьмите в долг [gold]{fee} золота[/gold].\nВ начале каждого хода добавьте карту [gold]Зарплата[/gold] в руку.",
    ...
    {
        ["DEBTOR_CARD.title"] = "เจ้าหนี้",
        ["DEBTOR_CARD.description"] = "ทำ[gold]การชำระ[/gold] [gold]{gold} ทอง[/gold]\nหากยังอยู่ในมือเมื่อจบเทิร์น เสียพลังชีวิต [b]{hp}[/b] และชำระอยู่ดี",
        ["WAGES_CARD.title"] = "ค่าจ้าง",
        ["WAGES_CARD.description"] = "รับ [gold]{gold} ทอง[/gold]",
        ["JOB_PLACEMENT_CARD.title"] = "จัดหางาน",
        ["JOB_PLACEMENT_CARD.description"] = "ยืม [gold]{fee} ทอง[/gold] เข้าหนี้ของคุณ\nเมื่อเริ่มแต่ละเทิร์น เพิ่มการ์ด[gold]ค่าจ้าง[/gold]เข้ามือ",
    ...
    {
        ["DEBTOR_CARD.title"] = "Tahsildar",
        ["DEBTOR_CARD.description"] = "[gold]{gold} Altın[/gold] [gold]Ödeme[/gold] yap.\nTur sonunda hâlâ elindeyse [b]{hp}[/b] Can kaybet ve yine de Ödemeyi yap.",
        ["WAGES_CARD.title"] = "Maaş",
        ["WAGES_CARD.description"] = "[gold]{gold} Altın[/gold] kazan.",
        ["JOB_PLACEMENT_CARD.title"] = "İş Bulma",
        ["JOB_PLACEMENT_CARD.description"] = "Borcuna [gold]{fee} Altın[/gold] ekleyerek borç al.\nHer turun başında eline bir [gold]Maaş[/gold] kartı ekle.",
    ...
    private static readonly Dictionary<string, string> _powersJpn = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "各ターン開始時、借金取りカードを手札に加える。3ターンごとに強くなる。",
    ...
    {
        ["BAD_CREDIT_POWER.title"] = "信用不良",
        ["BAD_CREDIT_POWER.description"] = "每回合开始时，将一张讨债人牌加入手牌。每3回合变得更强。",
    ...
    private static readonly Dictionary<string, string> _powersDeu = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "Lege zu Beginn jeder Runde eine Schuldeneintreiber-Karte auf deine Hand. Alle 3 Runden wird sie stärker.",
    ...
    private static readonly Dictionary<string, string> _powersFra = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "Au début de chaque tour, ajoute une carte Créancier à ta main. Tous les 3 tours, elle devient plus forte.",
    ...
    private static readonly Dictionary<string, string> _powersSpa = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "Al inicio de cada turno, añade una carta de Cobrador a tu mano. Cada 3 turnos se vuelve más fuerte.",
    ...
    private static readonly Dictionary<string, string> _powersIta = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "All'inizio di ogni turno, aggiungi una carta Esattore alla tua mano. Ogni 3 turni diventa più forte.",
    ...
    private static readonly Dictionary<string, string> _powersPol = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "Na początku każdej tury dodaj kartę Windykator do ręki. Co 3 tury staje się silniejsza.",
    ...
    private static readonly Dictionary<string, string> _powersPtb = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "No início de cada turno, adicione uma carta de Cobrador à sua mão. A cada 3 turnos fica mais forte.",
    ...
    private static readonly Dictionary<string, string> _powersRus = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "В начале каждого хода добавьте карту Долговой сборщик в руку. Каждый 3-й ход она усиливается.",
    ...
    private static readonly Dictionary<string, string> _powersTha = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "เมื่อเริ่มแต่ละเทิร์น เพิ่มการ์ดเจ้าหนี้เข้ามือ ทุก 3 เทิร์นจะแข็งแกร่งขึ้น",
    ...
    private static readonly Dictionary<string, string> _powersTur = new()
    {
        ...
        ["BAD_CREDIT_POWER.description"] = "Her turun başında eline bir Tahsildar kartı ekle. Her 3 turda bir güçlenir.",
