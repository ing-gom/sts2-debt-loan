...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, Row> ByLang = new()
    {
        ["eng"] = new("Merchant's Ledger",
            "Owed [gold]{owed} Gold[/gold]. Paid [gold]{paid} Gold[/gold] so far.\nInjected each combat: [b]{cards:choose(1|2|3|4):Debt|Debt, Delinquency|Debt, Delinquency, Seizure|Bad Credit|Debt}[/b]. More curses pile on the longer you owe.\nRepay the debt at a shop to remove this relic.",
        ...
        ["kor"] = new("상인의 장부",
            "남은 상환액 [gold]{owed} 골드[/gold]. 지금까지 지불 [gold]{paid} 골드[/gold].\n전투마다 주입되는 저주: [b]{cards:choose(1|2|3|4):빚|빚, 연체|빚, 연체, 차압|신용 불량|빚}[/b]. 오래 갚지 않을수록 늘어납니다.\n상점에서 빚을 갚으면 이 유물이 제거됩니다.",
            "모든 서명은 작은 항복이다.",
        ...
        ["zhs"] = new("商人的账簿",
            "待还 [gold]{owed} 金币[/gold]。已偿还 [gold]{paid} 金币[/gold]。\n每场战斗注入的诅咒：[b]{cards:choose(1|2|3|4):债务|债务、拖欠|债务、拖欠、扣押|信用不良|债务}[/b]。拖欠越久，诅咒越多。\n在商店还清债务即可移除此遗物。",
            "每一个签名都是一次小小的屈服。",
        ...
        ["deu"] = new("Händlerbuch",
            "Offen: [gold]{owed} Gold[/gold]. Zurückgezahlt: [gold]{paid} Gold[/gold].\nJeder Kampf schleust ein: [b]{cards:choose(1|2|3|4):Schuld|Schuld, Verzug|Schuld, Verzug, Pfändung|Zahlungsunfähig|Schuld}[/b]. Je länger du schuldest, desto mehr Flüche.\nZahle die Schuld in einem Laden zurück, um dieses Relikt zu entfernen.",
        ...
        ["fra"] = new("Grand livre du marchand",
            "Dû : [gold]{owed} or[/gold]. Remboursé : [gold]{paid} or[/gold].\nInjecté à chaque combat : [b]{cards:choose(1|2|3|4):Dette|Dette, Défaut|Dette, Défaut, Saisie|Insolvabilité|Dette}[/b]. Plus tu tardes, plus il y a de malédictions.\nRembourse la dette dans une boutique pour retirer cette relique.",
        ...
        ["spa"] = new("Libro del mercader",
            "Pendiente: [gold]{owed} de oro[/gold]. Pagado: [gold]{paid} de oro[/gold].\nInyectado cada combate: [b]{cards:choose(1|2|3|4):Deuda|Deuda, Morosidad|Deuda, Morosidad, Embargo|Insolvencia|Deuda}[/b]. Cuanto más debas, más maldiciones.\nSalda la deuda en una tienda para eliminar esta reliquia.",
        ...
        ["ita"] = new("Registro del mercante",
            "Dovuto: [gold]{owed} Oro[/gold]. Pagato: [gold]{paid} Oro[/gold].\nInserito ogni combattimento: [b]{cards:choose(1|2|3|4):Debito|Debito, Morosità|Debito, Morosità, Pignoramento|Insolvenza|Debito}[/b]. Più tardi, più maledizioni.\nSalda il debito in un negozio per rimuovere questo cimelio.",
        ...
        ["pol"] = new("Księga kupca",
            "Do spłaty: [gold]{owed} złota[/gold]. Spłacono: [gold]{paid} złota[/gold].\nDodawane w każdej walce: [b]{cards:choose(1|2|3|4):Dług|Dług, Zaległość|Dług, Zaległość, Zajęcie|Niewypłacalność|Dług}[/b]. Im dłużej zwlekasz, tym więcej klątw.\nSpłać dług w sklepie, aby usunąć ten relikt.",
        ...
        ["ptb"] = new("Livro-razão do mercador",
            "Devido: [gold]{owed} de Ouro[/gold]. Pago: [gold]{paid} de Ouro[/gold].\nInjetado a cada combate: [b]{cards:choose(1|2|3|4):Dívida|Dívida, Inadimplência|Dívida, Inadimplência, Penhora|Crédito Ruim|Dívida}[/b]. Quanto mais você deve, mais maldições.\nQuite a dívida em uma loja para remover esta relíquia.",
        ...
        ["rus"] = new("Гроссбух торговца",
            "К оплате: [gold]{owed} золота[/gold]. Выплачено: [gold]{paid} золота[/gold].\nДобавляется каждый бой: [b]{cards:choose(1|2|3|4):Долг|Долг, Просрочка|Долг, Просрочка, Арест|Неплатёжеспособность|Долг}[/b]. Чем дольше долг, тем больше проклятий.\nПогасите долг в магазине, чтобы убрать эту реликвию.",
        ...
        ["tha"] = new("บัญชีของพ่อค้า",
            "ค้างชำระ [gold]{owed} ทอง[/gold] จ่ายไปแล้ว [gold]{paid} ทอง[/gold]\nใส่ทุกการต่อสู้: [b]{cards:choose(1|2|3|4):หนี้|หนี้, ค้างชำระ|หนี้, ค้างชำระ, ยึดทรัพย์|เครดิตเสีย|หนี้}[/b] ยิ่งค้างนานยิ่งมากขึ้น\nชำระหนี้ที่ร้านค้าเพื่อนำวัตถุโบราณนี้ออก",
        ...
        ["tur"] = new("Tüccarın Defteri",
            "Kalan: [gold]{owed} Altın[/gold]. Ödenen: [gold]{paid} Altın[/gold].\nHer savaş eklenir: [b]{cards:choose(1|2|3|4):Borç|Borç, Temerrüt|Borç, Temerrüt, Haciz|Kredi İflası|Borç}[/b]. Borç uzadıkça daha fazla lanet.\nBu kalıntıyı kaldırmak için borcu bir dükkânda öde.",
