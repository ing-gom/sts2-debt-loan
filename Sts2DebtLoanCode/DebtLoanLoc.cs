...
internal static class DebtLoanLoc
{
    ...
    {
        public readonly string Title, Hint, Price, Sold, Close, Credit, OverLimit;
        public DebtShopUiRow(string title, string hint, string price, string sold, string close,
                             string credit, string overLimit)
        { Title = title; Hint = hint; Price = price; Sold = sold; Close = close; Credit = credit; OverLimit = overLimit; }
    }
    ...
    private static readonly Dictionary<string, DebtShopUiRow> DebtShopUiByLang = new()
    {
        ...
        ["eng"] = new("Buy on Credit", "Press to enter the debt shop.", "Debt {0}", "SOLD", "Back to Shop", "Credit {0}/{1}", "OVER LIMIT"),
        ["kor"] = new("외상 구매", "누르면 빚 상점으로 이동됩니다.", "빚 {0}", "품절", "상점으로 돌아가기", "대출 가능 {0}/{1}", "한도 초과"),
        ["jpn"] = new("ツケで購入", "押すと借金ショップへ移動します。", "借金 {0}", "売切れ", "ショップに戻る", "融資枠 {0}/{1}", "限度額超過"),
        ["zhs"] = new("赊购", "点击进入赊账商店。", "债务 {0}", "售罄", "返回商店", "额度 {0}/{1}", "超出额度"),
        ["deu"] = new("Auf Kredit kaufen", "Drücken, um den Schuldenladen zu öffnen.", "Schuld {0}", "VERKAUFT", "Zurück zum Laden", "Kredit {0}/{1}", "ÜBER LIMIT"),
        ["fra"] = new("Acheter à crédit", "Appuyer pour ouvrir la boutique de crédit.", "Dette {0}", "VENDU", "Retour à la boutique", "Crédit {0}/{1}", "LIMITE DÉPASSÉE"),
        ["spa"] = new("Comprar a crédito", "Pulsa para ir a la tienda de crédito.", "Deuda {0}", "VENDIDO", "Volver a la tienda", "Crédito {0}/{1}", "LÍMITE SUPERADO"),
        ["esp"] = new("Comprar a crédito", "Pulsa para ir a la tienda de crédito.", "Deuda {0}", "VENDIDO", "Volver a la tienda", "Crédito {0}/{1}", "LÍMITE SUPERADO"),
        ["ita"] = new("Compra a credito", "Premi per aprire il negozio a credito.", "Debito {0}", "VENDUTO", "Torna al negozio", "Credito {0}/{1}", "OLTRE IL LIMITE"),
        ["pol"] = new("Kup na kredyt", "Naciśnij, aby przejść do sklepu na kredyt.", "Dług {0}", "SPRZEDANE", "Wróć do sklepu", "Kredyt {0}/{1}", "PONAD LIMIT"),
        ["ptb"] = new("Comprar fiado", "Pressione para ir à loja fiado.", "Dívida {0}", "VENDIDO", "Voltar à loja", "Crédito {0}/{1}", "ACIMA DO LIMITE"),
        ["rus"] = new("Купить в долг", "Нажмите, чтобы открыть долговой магазин.", "Долг {0}", "ПРОДАНО", "Вернуться в магазин", "Кредит {0}/{1}", "СВЕРХ ЛИМИТА"),
        ["tha"] = new("ซื้อเงินเชื่อ", "กดเพื่อไปยังร้านค้าเงินเชื่อ", "หนี้ {0}", "ขายแล้ว", "กลับไปที่ร้านค้า", "วงเงิน {0}/{1}", "เกินวงเงิน"),
        ["tur"] = new("Borçla Satın Al", "Borç dükkânına gitmek için bas.", "Borç {0}", "SATILDI", "Dükkâna dön", "Kredi {0}/{1}", "LİMİT AŞILDI"),
    };
