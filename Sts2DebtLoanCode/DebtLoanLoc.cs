...
internal static class DebtLoanLoc
{
    ...
    private static readonly Dictionary<string, string> _cardsEng = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Deal [b]{Damage}[/b] damage [b]{CalculatedHits}[/b] times (based on [gold]Receipts[/gold] held).",
    ...
    private static readonly Dictionary<string, string> _cardsKor = new()
    {
        ...
        ["INVOICE_CARD.description"] = "적에게 [b]{Damage}[/b]의 피해를 [b]{CalculatedHits}[/b]번 줍니다 (보유한 [gold]영수증[/gold] 수만큼).",
    ...
    private static readonly Dictionary<string, string> _cardsJpn = new()
    {
        ...
        ["INVOICE_CARD.description"] = "[b]{Damage}[/b]のダメージを[b]{CalculatedHits}[/b]回与える（所持[gold]レシート[/gold]数に応じて）。",
    ...
    private static readonly Dictionary<string, string> _cardsZhs = new()
    {
        ...
        ["INVOICE_CARD.description"] = "造成 [b]{Damage}[/b] 点伤害，共 [b]{CalculatedHits}[/b] 次（取决于持有的[gold]收据[/gold]数量）。",
    ...
    private static readonly Dictionary<string, string> _cardsDeu = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Füge [b]{Damage}[/b] Schaden [b]{CalculatedHits}[/b]-mal zu (abhängig von gehaltenen [gold]Belegen[/gold]).",
    ...
    private static readonly Dictionary<string, string> _cardsFra = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Inflige [b]{Damage}[/b] dégâts [b]{CalculatedHits}[/b] fois (selon les [gold]reçus[/gold] possédés).",
    ...
    private static readonly Dictionary<string, string> _cardsSpa = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Inflige [b]{Damage}[/b] de daño [b]{CalculatedHits}[/b] veces (según los [gold]recibos[/gold] que tengas).",
    ...
    private static readonly Dictionary<string, string> _cardsIta = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Infliggi [b]{Damage}[/b] danni [b]{CalculatedHits}[/b] volte (in base alle [gold]ricevute[/gold] possedute).",
    ...
    private static readonly Dictionary<string, string> _cardsPol = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Zadaj [b]{Damage}[/b] obrażeń [b]{CalculatedHits}[/b] razy (zależnie od posiadanych [gold]paragonów[/gold]).",
    ...
    private static readonly Dictionary<string, string> _cardsPtb = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Cause [b]{Damage}[/b] de dano [b]{CalculatedHits}[/b] vezes (conforme os [gold]recibos[/gold] que você possui).",
    ...
    private static readonly Dictionary<string, string> _cardsRus = new()
    {
        ...
        ["INVOICE_CARD.description"] = "Нанесите [b]{Damage}[/b] урона [b]{CalculatedHits}[/b] раз (зависит от имеющихся [gold]чеков[/gold]).",
    ...
    private static readonly Dictionary<string, string> _cardsTha = new()
    {
        ...
        ["INVOICE_CARD.description"] = "สร้างความเสียหาย [b]{Damage}[/b] จำนวน [b]{CalculatedHits}[/b] ครั้ง (ตาม[gold]ใบเสร็จ[/gold]ที่ถืออยู่)",
    ...
    private static readonly Dictionary<string, string> _cardsTur = new()
    {
        ...
        ["INVOICE_CARD.title"] = "Fatura",
        ["INVOICE_CARD.description"] = "[b]{Damage}[/b] hasarı [b]{CalculatedHits}[/b] kez ver (elinde tuttuğun [gold]makbuz[/gold] sayısına göre).",
